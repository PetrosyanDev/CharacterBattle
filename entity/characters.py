...
# Zapdos
Zapdos = Character(name="Zapdos", elements=["ELECTRIC", "FLYING"], max_hp=180, atk=175,  defense=178, frames=["./assets/zapdos_1.png"])
Zapdos.add_ability(ability.thunder_shock)
Zapdos.add_ability(ability.drill_peck)

# Charizard
Charizard = Character(name="Charizard", elements=["FIRE", "FLYING"], max_hp=129, atk=198, defense=168, frames=["./assets/charizard_1.png"])
...
Pidgeot = Character(name="Pidgeot",elements=["NORMAL", "FLYING"], max_hp=200, atk=156, defense=154, frames=["./assets/pidgeot_1.png"])
